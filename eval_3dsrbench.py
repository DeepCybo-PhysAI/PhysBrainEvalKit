...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset_name", type=str, default="datasets/3DSRBench/3DSRBench/3dsrbench_v1_vlmevalkit_circular.tsv", help="Dataset path or HF dataset name")
